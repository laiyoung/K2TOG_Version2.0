...
jest.mock('../controllers/analyticsController', () => {
    ...
    return {
        getDashboardSummary: jest.fn().mockImplementation(() => Promise.resolve(mockData.dashboardSummary)),
        getRevenueAnalytics: jest.fn().mockImplementation(() => Promise.resolve(mockData.revenueAnalytics)),
        getRevenueByClass: jest.fn().mockImplementation(() => Promise.resolve(mockData.revenueByClass)),
        getEnrollmentTrends: jest.fn().mockImplementation(() => Promise.resolve(mockData.enrollmentTrends)),
        getClassEnrollmentStats: jest.fn().mockImplementation(() => Promise.resolve(mockData.classEnrollmentStats)),
        getUserEngagementMetrics: jest.fn().mockImplementation(() => Promise.resolve(mockData.userEngagementMetrics)),
        getUserActivityTrends: jest.fn().mockImplementation(() => Promise.resolve(mockData.userActivityTrends))
    };
});
...
describe('Analytics Routes', () => {
    ...
    const makeRequest = (method, path, token = adminToken, query = {}) => {
        return request(app)[method.toLowerCase()]('/api/admin/analytics' + path)
            .query(query)
    ...
    describe('GET /api/admin/analytics/revenue', () => {
        ...
        it('should fail when dates are missing', async () => {
            ...
            expect(res.body).toHaveProperty('error', 'Start date and end date are required');
        }, 15000);
    });
